          ...
          <div data-aos="slide-right" className="row justify-content-center" id="main">
              ...
              <p className="card-text" id="sub-title-1">
                 <span id="badge" className="badge">
                     <img id="icon-ligo" src="https://res.cloudinary.com/dhqsixgmo/image/upload/v1675075008/LigoLab_Template_Scratch_10_jqgdp8_fwilt8.ico"></img>
                 </span>
                Schedule a free consultation to learn how you can integrate custom revenue cycle management,
                automation, and executive-level analytics to secure sustained long-term profitability & growth.
              </p>
                ...
                <p className="card-text" id="sub-title-1">
                  ...
                  setting the bar when it comes to laboratory operational success!
                </p>
          </div>
          
<div className='row justify content-center'>
  <div className='col-2'></div>
<div data-aos="slide-left" className="col-8 justify-content-center" id="contact-form">
        ...
        <form className="wow pulse" action="https://formspree.io/f/maykpnjz" method="POST">
            <div className="form-group">
                ...
                <div className="row">
                    <div className="col-4-mx-auto">
                        <label htmlFor="email"><i className="fa-solid fa-envelope"></i> Email: <i id="ast"
                                                                                                  className="fa-solid fa-asterisk"></i></label>
                ...
                <div className="row justify-content-center">
                    <div className="col-4-mx-auto">
                        <label htmlFor="company"><i className="fa-regular fa-registered"> </i> Company/Laboratory
                    ...
                    <div className="col-4-mx-auto">
                        <label htmlFor="state"><i className="fa-solid fa-map-pin"></i> Company Location - State: <i id="ast"
                                                                                                 className="fa-solid fa-asterisk"></i></label>
                ...
                <div className="row justify-content-center" id="heading">
                    ...
                    <div className="col-7-mx-auto">
                        <label htmlFor="select"><i className="fa-solid fa-clipboard-check"></i> Please Select An Area of
                ...
                <div className="row justify-content-center">
                    <div className="col-7 mb-4">
                        <label htmlFor="details"> <i className="fa-solid fa-briefcase"></i> Please Share Laboratory
