					...
					<div className="row">
						<div className="col-12 mx-auto">
							<a
								...
								<img data-aos="zoom-in" id="footer-logo" className="img-fluid" src="https://res.cloudinary.com/dhqsixgmo/image/upload/v1678393986/full_logo_2_riwvlb.svg" alt="ligolab.com" />
							</a>
